...
import by.uladzimirmakei.taskone.repository.listener.impl.WarehouseObserverImp;
import by.uladzimirmakei.taskone.service.util.GeneratorId;

import java.util.Arrays;

import static by.uladzimirmakei.taskone.service.util.ArrayUtil.*;
...
public class CostumerArray implements WarehouseListener {
    ...
    public CostumerArray(int[] array) throws ArrayException {
        if (!isArrayValid(array)) {
            throw new ArrayException(
                    "Array is null or array's length is invalid");
        }
        this.array = array;
    ...
    public void setArrayElement(int elementIndex, int value)
