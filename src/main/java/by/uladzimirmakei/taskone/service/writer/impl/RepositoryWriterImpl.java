package by.uladzimirmakei.taskone.service.writer.impl;
...
import by.uladzimirmakei.taskone.service.writer.RepositoryWriter;
    ...
    public void write() throws FileException {
        ...
        try (PrintWriter writer = new PrintWriter(
            ...
            throw new FileException(
                    "RepositoryReader unable to read data from file "
                            + RESULT_FILE_PATH, e);
        }
    }
}
